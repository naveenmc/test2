...
registerOnClick('plank_wood1', false, false, [0,1,2], function() {
  replaceTexture('wood_original', 'Map #6', 'wood_basecolor_1.jpg', function() {});
}, function() {});

registerOnClick('plank_wood2', false, false, [0,1,2], function() {
  replaceTexture('wood_original', 'Map #6', 'wood_basecolor_2.jpg', function() {});
}, function() {});

registerOnClick('plank_wood3', false, false, [0,1,2], function() {
  replaceTexture('wood_original', 'Map #6', 'wood_basecolor_3.jpg', function() {});
}, function() {});
